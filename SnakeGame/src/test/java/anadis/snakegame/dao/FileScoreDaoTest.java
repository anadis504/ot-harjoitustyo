...
public class FileScoreDaoTest {
    ...
    public void highestScoreComesFirst() {
        scoreDao.add("alice", 13, 1, java.time.LocalDateTime.now());
    ...
    public void lowestLevelComesFirst() {
        scoreDao.add("bob", 22, 2, java.time.LocalDateTime.now());
    ...
    public void scoresAreSortedByTimestamp() {
        scoreDao.add("alice", 12, 1, java.time.LocalDateTime.now());
